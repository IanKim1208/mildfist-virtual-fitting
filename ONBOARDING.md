...
**작업 도구**: Claude Design (claude.ai/design)을 사용하여 진행합니다.

**디자인 방향**: 확정된 디자인 시안은 없습니다. 프로젝트 루트의 `DESIGN.md`(Pinterest 기반)를 참고하되, 패션/가상 피팅 서비스에 맞는 방향으로 자유롭게 개선해주시면 됩니다. 현재 UI보다 더 나은 결과물이 나오면 됩니다.
